import{_ as a,o as e,c as s,a as n}from"./app-c79c7744.js";const l={},i=n(`<ol><li><p>生成jmod文件</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>jmod create --class-path target/classes ^ （字节码路径）
